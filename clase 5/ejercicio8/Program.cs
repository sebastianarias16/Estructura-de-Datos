...
namespace ejercicio8
{
    class Program
    {
        static void Main(string[] args)
        {
                ...
                Console.WriteLine("Ahora vamos a multiplicar dos matrizes");
                Console.WriteLine("");
                ...
                Console.WriteLine(" ");
                Console.WriteLine("El producto de M1 y M2 es la siguiente:");
                Console.WriteLine(" ");

                float[,] MP = new float[filas, columnas];
                ...
                for (int f = 0; f < M1.GetLongLength(0); f++)
                {
                    ...
                    for (int c = 0; c < M1.GetLongLength(1); c++)
                    {
                        ...
                        MP[f, c] = M1[f, c] * M2[f, c];
                        Console.Write("    " + MP[f, c] + " ");
                    }
                    Console.WriteLine();
                }

            Console.WriteLine("gracias por estar con consotros nos veremos en la proxima");
        }
    }
}
